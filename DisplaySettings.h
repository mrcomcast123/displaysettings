...
namespace WPEFramework {
  ...
  namespace Plugin {
      ...
      typedef Core::JSON::String JSONString;
      typedef Core::JSON::ArrayType<JSONString> JSONStringArray;
      

      //Begin methods

      //Params:empty Response:array of strings
			uint32_t getConnectedVideoDisplays(const Params& parameters, JSONStringArray& response) {
      ...
      //Params:empty Response:array of strings
			uint32_t getConnectedAudioPorts(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay Response:array of strings
			uint32_t getSupportedResolutions(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay Response:array of strings
			uint32_t getSupportedTvResolutions(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:empty Response:array of strings
			uint32_t getSupportedAudioPorts(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:audioPort Response:array of strings
			uint32_t getSupportedAudioModes(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:empty Response:string
			uint32_t getZoomSetting(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:zoomLevel Response:empty
			uint32_t setZoomSetting(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay Response:string
			uint32_t getCurrentResolution(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay,resolution Response:empty
			uint32_t setCurrentResolution(const Params& parameters, JSONString& response) {
//        Params params;
//        params.FromString(parameters);
      ...
      //Params:videoDisplay Response:string
			uint32_t getSoundMode(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay,soundMode Response:bool
			uint32_t setSoundMode(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:empty Response:string
			uint32_t readEDID(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:empty Response:string
			uint32_t readHostEDID(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //Params:videoDisplay Response:bool
			uint32_t getActiveInput(const Params& parameters, JSONString& response) {
				response = "\"NOTIMPL\"";
				return (Core::ERROR_NONE);
			}
      //End methods
